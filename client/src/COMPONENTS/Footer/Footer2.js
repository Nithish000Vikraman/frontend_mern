    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>FITNESS-HUB is a leading online protein store in India. 
            We are committed to providing the best quality products at the best prices.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2024 FITNESS-HUB, Inc.  All rights reserved</h3>
